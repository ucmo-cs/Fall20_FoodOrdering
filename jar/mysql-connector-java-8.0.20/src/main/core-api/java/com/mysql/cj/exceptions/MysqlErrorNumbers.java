...
public final class MysqlErrorNumbers {
    ...
    public final static int ER_HOST_NOT_PRIVILEGED = 1130; //SQLSTATE: HY000 Message: Host '%s' is not allowed to library.test.connect to this MySQL server
    ...
    public final static int ER_CONNECT_TO_FOREIGN_DATA_SOURCE = 1429; //SQLSTATE: HY000 Message: Unable to library.test.connect to foreign data source: %s
