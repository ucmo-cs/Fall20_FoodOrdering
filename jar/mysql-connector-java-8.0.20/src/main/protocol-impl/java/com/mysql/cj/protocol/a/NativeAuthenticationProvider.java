...
public class NativeAuthenticationProvider implements AuthenticationProvider<NativePacketPayload> {
     ...
     * at any moment during the connection life-time via a Change Models.User request.
     * 
     ...
     * @param database
     *            database to library.test.connect to (can be empty)
     * @param challenge
    ...
    private void proceedHandshakeWithPluggableAuthentication(ServerSession serverSession, String user, String password, String database,
        ...
        // Servers not affected by Bug#70865 expect the Change Models.User Request containing a correct answer
